  ...
  return (
    <div className='mt-12'>
        ...
        className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg
         h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3'>
            <div className='flex justify-between items-center '>
              <div>
                <p className='font-bold dark:text-blue-600 text-gray-400'>Earnings</p>
                <p className='text-xl dark:font-semibold'>$63,448.78</p>
              </div>
              <button
              type="button"
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
          ...
          dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl w-780'>
                ...
                <div className='border-r-1 border-color m-4 pr-10'>
                  <div>
                    <p>
                      ...
                      <span className='p-1 hover:drop-shadow-xl
                        cursor-pointer
                        rounded-full
                        text-white
