    ...
    w-screen fixed nav-item top-0 right-0'>
      ...
      className='float-right h-screen dark:bg-secondary-dark-bg dark:text-gray-200 bg-white dark:[#484B52] w-400'>
        ...
        className='flex justify-between items-center p-4 ml-4'>
          ...
          <button
          className='mr-8 text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray'
          type='button'
        ...
        className='flex-col border-t-1 border-color p-4 ml-4'>
          ...
          className='mt-4'>
            ...
            />
            <label htmlFor='light'
            className='ml-2 text-sm cursor-pointer'>Light</label>
          </div>
          <div
          className='mt-4'>
            <input 
            ...
            />
            <label htmlFor='dark'
            className='ml-2 text-sm cursor-pointer'>Dark</label>
          </div>
        </div>
        <div
        className='flex-col border-t-1 border-color p-4 ml-4'>
